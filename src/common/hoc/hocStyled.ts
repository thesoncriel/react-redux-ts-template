 ...
 */
export const hocStyled = <P>(comp: ComponentType<P>, cssStyles: FlattenSimpleInterpolation) => {
  const wrapComp: StyledComponent<ComponentType<P>, any, any, never> = styled(comp)`${cssStyles}`;
