...
import { actSampleListFail, actSampleListLoad, actSampleListLoaded } from '../actions';

/**
 * 이펙트: 샘플 목록을 불러온다.
 */
export const effSampleListLoad = createEffect<SampleListLoadParams>(async (payload, dispatch) => {
